...
$qry=mysqli_query($conn,"insert into verbal(v_question,vo_1,vo_2,vo_3,vo_4)values('$ques','$opa','$opb','$opc','$opd')") or die(mysqli_error($conn));
