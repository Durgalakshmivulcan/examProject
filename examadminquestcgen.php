...
if(isset ($_POST['save'])){
    $quesgen=$_POST['name'];
    $qry=mysqli_query($conn,"insert into technicalgen(tcq_question)values('$quesgen')") or die(mysqli_error($conn)); 
if($quesgen!=''){
    echo '<script>';
    echo   "Swal.fire({
           icon: 'success',
...
<div class="row p-0 m-0">
    <div class="col-xl-3 col-lg-3 col-md-3 mt-5"></div>
        ...
        <h1 style="margin-bottom:30px;margin-left:100px;">Technical general questions </h1>
                <table border="0px">
                    <tr>
                        <td>Question:</td>
