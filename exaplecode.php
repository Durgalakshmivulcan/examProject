...
$Getname=mysqli_query($conn, "SELECT * FROM userlogin WHERE u_status='1'and u_id='$main_id1'") or die(mysqli_error($conn));
...
<div id="timer"style="color:white;font-size:40px;"> 
        ...
        <div class="col-xl-8 col-lg-8 ms-5 ps-5"style="height:400px;padding:10px;margin-top:10px;">
            <div class="panel">
                ...
                <table border="0px">
                    ...
                    <tr>
                        <td colspan="3"><center><input class="btn btn-primary rounded-pill;" onclick="setQuestionButtonBackground(nextid)" type="button" name="save" id="save" value="Next"></center></td>
                    </tr>
                </table> 
...
<table border="0px" >
                    <tr>
                    <td><center><input onclick="previous()" class="btn btn-warning rounded-pill" type="button" name="save2" id="save2" value="<<Previous"></center></td>
                    </tr> 
</table> 
</div>
...
<table border="0px" >
                    <tr>
                    <td><center><input onclick="nextsection()" class="btn btn-warning rounded-pill" type="button" name="save1" id="save1" value="Next>>"></center></td>
                    </tr> 
</table> 
</div>
...
<table border="0px" >
                    <tr>
                    <td><center><input onclick="submit()" class="btn btn-success ms-3 rounded-pill" type="button" name="submit" id="submit" value="Submit"></center></td>
...
function setQuestionButtonBackground(currentApId) {
    document.getElementById("q" + currentApId).style.background='yellow';
...
function saveAnswer(currentApId, selectedOption) {
    $.ajax({
        url: 'examsaveanswer.php',
        type: 'POST',
        data: { question_id: currentApId, answer_id: selectedOption },
