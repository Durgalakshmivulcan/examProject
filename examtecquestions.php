...
$qry=mysqli_query($conn,"insert into technical(t_question,t_1,t_2,t_3,t_4)values('$ques','$opa','$opb','$opc','$opd')") or die(mysqli_error($conn));
...
<div class="row p-0 m-0">
    <div class="col-xl-3 col-lg-3 col-md-3 mt-5"></div>
        <div class="col-xl-7 col-lg-7"style="height:400px;padding:50px;">
                <h1>Technical Questions page</h1>
                <table border="0px">
                    <tr>
                    <tr>
